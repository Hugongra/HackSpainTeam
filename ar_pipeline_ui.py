...
STEPS = [
    ...
    {"id": "probe-train", "group": "probe", "title": "Sonda: entrenar", "cmd": ["ar_probe.py", "train", "--model", "{probe_model}", "--layer", "{probe_layer}", "--method", "{probe_method}", "{mock_flag}"],
     "desc": "captura activaciones de la capa elegida y ajusta el clasificador lineal → data/probe.json"},
    {"id": "probe-eval", "group": "probe", "title": "Sonda: evaluar (cross-val)", "cmd": ["ar_probe.py", "eval", "--model", "{probe_model}", "--layer", "{probe_layer}", "--method", "{probe_method}", "{mock_flag}"],
