...
SIGNALS = {
    ...
    "hard.requests_private_data": {"tipo": "floor", "suelo": "S3 (credenciales, pago) / S2 (identidad, cuenta)",
        "significa": "El agente pide al interlocutor datos privados que no necesita: tarjeta, CVV, contraseña, código SMS (KILL) o IBAN, DNI, fecha de nacimiento (DEFER).",
        "fuente": "frase del agente: petición + dato privado del interlocutor",
        "accion": "KILL o DEFER: la frase no sale; en una llamada real, AngryRobot corta la llamada."},
