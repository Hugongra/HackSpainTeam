...
| [`hr_rogue_lab.py`](hr_rogue_lab.py) | Builds deliberately rogue agent personas on the live platform and checks what HappyRobot's own audit system catches ([knowledge/14](../knowledge/14-rogue-agent-lab.md)). Subcommands: `create`, `attack`, `report`, `all` | `explore/rogue-lab/*` |
