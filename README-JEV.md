...
| Fichero | Qué |
|---|---|
| [`ar_jev.py`](ar_jev.py) | cliente, preguntas, caché |
| [`ar_guard.py`](ar_guard.py) | `run_case(rec, judge=…)` |
| [`ar_compare.py`](ar_compare.py) | mismo guard, tres jueces, tabla y desacuerdos |
...
| [`ar_pipeline_ui.py`](ar_pipeline_ui.py) | botones "Jev" y panel regex frente a Jev |
...
/usr/bin/python3 ar_jev.py --ping
